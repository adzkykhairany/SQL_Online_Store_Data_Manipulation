...
INSERT INTO TrCustomer(CustomerName, PhoneNumber, Email) VALUES 
...
CREATE TABLE TrShop(
    ...
    Address VARCHAR(255),
    PRIMARY KEY(IDShop),
    CONSTRAINT CheckShop1 CHECK (IDShop REGEXP 'SH[0-9][0-9][0-9][A-Z]')
);

INSERT INTO TrShop(IDShop, ShopName, Owner, isOfficial, Address) VALUES
...
CREATE TABLE MsProduct(
    ...
    IDShop CHAR(7) REFERENCES TrShop(IDShop) ON UPDATE CASCADE ON DELETE CASCADE,
    ProductName VARCHAR(50),
    Stock INT,
    Price DECIMAL(12,2),
    PRIMARY KEY(IDProduct),
    CONSTRAINT CheckProduct1 CHECK (IDShop REGEXP 'SH[0-9][0-9][0-9][A-Z]'),
    CONSTRAINT CheckProduct2 CHECK (Stock >= 0)
);

INSERT INTO MsProduct(IDShop, ProductName, Stock, Price) VALUES
-- SHOP 1
...
CREATE TABLE TrTransaction(
	IDTransaction VARCHAR(6) PRIMARY KEY,
    IDProduct INT REFERENCES MsProduct(IDProduct) ON UPDATE CASCADE ON DELETE SET NULL,
    IDCustomer INT REFERENCES TrCustomer(IDCustomer) ON UPDATE CASCADE ON DELETE SET NULL,
    TransactionDate DATETIME,
    Qty INT,
    TotalPrice DECIMAL(12,2),
    Done BOOLEAN,
    PaymentMethod VARCHAR(20),
    CONSTRAINT CheckTrans1 CHECK (IDTransaction REGEXP 'TR[0-9][0-9][0-9]')
);
...
CREATE TABLE TrReview(
    ...
    Comment VARCHAR(255),
    Star INT,
    CONSTRAINT CheckRev1 CHECK (Star REGEXP '[1-5]')
);

INSERT INTO TrReview(IDProduct, Comment, Star) VALUES
(1,'Good',5),
(1,'Nice',4),
(2,'I dont like it',2),
(2,'Best product',5),
...
INSERT INTO TrCart(IDProduct, IDCustomer) VALUES
-- CUSTOMER 1
(1,1),
(3,1),
(4,1),
